...
Imagine that prior research says that the mean is probably $g=1.6$, and you are conducting a new study with $n=10$. Then one night Zeus comes to you in a dream and whispers in your ear that, in fact, the true values are $\mu=10$ and $\sigma^2=1$. Yeesh, with friends like Zeus, who needs statistics!
