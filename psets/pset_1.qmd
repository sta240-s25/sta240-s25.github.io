...
Rigorously prove this distributive property:
...
## Hint
Your solution will probably have take the following form:

*Proof.* 

- (showing $\subseteq$) Let $x\in(A\cap B)\cup C$...yadayadayadablahblah...Therefore, $x\in(A\cup C)\cap(B\cup C)$;
- (showing $\supseteq$) Let $x\in(A\cup C)\cap(B\cup C)$...yadayadayadablahblah...Therefore, $x\in(A\cap B)\cup C$.

Having established subsethood in both directions, we have the result. □
:::
...
$$
P(\text{``$A$ or $B$ but not both''})=P(A)+P(B)-2P(A\cap B).
$$
