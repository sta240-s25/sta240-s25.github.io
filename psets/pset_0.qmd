...
::: callout-tip
## Hint
Start on the left-hand side by writing out $\Gamma(x+1)$ and evaluating the integral. If you simplify the result correctly, you can make it look like $x\Gamma(x)$.
:::
