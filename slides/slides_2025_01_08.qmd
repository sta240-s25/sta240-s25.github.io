...
|              | Chen, Andy       | TA         | TBD             |
+--------------+------------------+------------+-----------------+
|![](h.jpg){.c}| Huang, Konnie    | TA         | TBD             |
+--------------+------------------+------------+-----------------+
|![](j.jpg){.c}| Jacobson, Gwen   | Head TA    | TBD             |
+--------------+------------------+------------+-----------------+
|![](z.jpg){.c}| Zito, John       | Instructor | Tue 2pm - 4pm   |
+--------------+------------------+------------+-----------------+
...
**Problem**: How do you optimally allocate your money to different assets (stocks vs bonds, Apple stock vs Microsoft, etc)?

**Goal**: You want to make the best choice subject to uncertainty about how the competing assets will ultimately perform.

The mathematics of this won a Nobel Prize in Economic Sciences in 1990. It's all just basic probability and statistics, creatively deployed.
...
Designed to be complete-able during the lab period, but due at 11:59 PM that same day.
:::
...
Violations of the policies on outside resources and collaboration will be referred to the conduct office and will result in zeros on the assignments.

## What level of mathematics should you expect?

This is essentially a pencil-and-paper math class. We assume all the basic skills taught in Calc I and II:
