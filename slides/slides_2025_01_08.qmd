...
The metastasis of cancer cells is frequently modeled using something called a *branching process*, and a kind of random evolution process that builds on the fundamentals of our course:
...
- Hopefully our coding needs are sufficiently basic that you don't feel the need to use outside resources too often, but telling you not use Google etc while coding is just insane. It's fine as long as you cite it.
...
::: callout-note
Like the wave-particle duality of light, both are true and useful, but their coexistence can be tense and uneasy.
:::
