...
I adore music of all kinds, but I know absolutely nothing about it. My kid brother Paul is a music ed major in college, and I am frequently harassing him with ridiculous questions about Ice Spice's use of the plagal cadence. I am as dumb as they come. But I do know something about probability, so to give you some inspiration, here is what I came up with after tinkering with this stuff for a few hours.
...
To complete this lab, please submit the following **on Canvas**:

- an `R` script (*not* Quarto!) with the code that generates your music. **Don't forget to set a seed**!
- the `.mp3` file;
...
To be clear, if you are totally not into this, but you can't afford to drop this assignment, then feel free to copy one of my examples, make a minor change, and submit. Otherwise, I encourage you to let the creative juices flow!