...
b. $P\left(A \cap B^{c} \cap C^{c}\right) + P\left(A^{c} \cap B \cap C^{c}\right) + P\left(A^{c} \cap B^{c} \cap C\right)$;
...
a. $\frac{\binom{100}{8} - \binom{98}{8}}{\binom{100}{8}}$;
b. $\frac{\binom{50}{15}\binom{50}{5}}{\binom{100}{20}}$;
c. $\frac{2^{50}}{\binom{100}{50}}$.
...
c. $10^{2} + 2 \times 9 \times 10 = 280$ PINs.
...
a. $\frac{1}{4}\sum_{x = 1}^{4}{\frac{\binom{5}{x}}{\binom{15}{x}}}$;
b. $\frac{\frac{\binom{5}{3}}{\binom{15}{3}}}{\sum_{x = 1}^{4}{\frac{\binom{5}{x}}{\binom{15}{x}}}}$.
