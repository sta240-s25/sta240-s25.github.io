...
Suppose the events $A$ and $B$ are disjoint. Under what conditions are $A^{c}$ and $B^{c}$ disjoint?

## Problem 2

Let $A_{1}$, $A_{2}$, and $A_{3}$ be three arbitrary events. Show that the probability that exactly one of these three events will occur is $$\mathbb{P}(A_{1}) + \mathbb{P}(A_{2}) + \mathbb{P}(A_{3}) - 2\mathbb{P}(A_{1} \cap A_{2}) - 2\mathbb{P}(A_{1} \cap A_{3}) - 2\mathbb{P}(A_{2} \cap A_{3}) + 3\mathbb{P}(A_{1} \cap A_{2} \cap A_{3}).$$
...
The United States Senate contains two seantors -- one senior and one junior -- from each of the $50$ states.

a. If a committee of eight senators is selcted, what is the probability that it will contain at least one of the two senators from a certain specified state?
