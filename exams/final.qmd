...
Here's a goofy cdf for some random variable $X$:
...
Let $X_1$, $X_2$, ..., $X_n$ be iid from some member of the parametric family that you studied in Problem XX above:
...
b.  What is the sampling distribution of the estimator? Problem XX might be helpful here.
...
Recall this family of distributions from Problems XX and XX above:
